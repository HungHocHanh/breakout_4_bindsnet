...
CHECKPOINT_PATH = "Izhikevich_exc_inh2.pth"
REWARD_LOG_FILE = "reward_log_izhikevich_ex_inh2.txt" 
TRAIN_EPISODES = 100
TEST_EPISODES = 100
CHECKPOINT_INTERVAL = 50 # Lưu mỗi 50 episode để tránh làm chậm máy

# Các thông số đã tinh chỉnh để AI học ổn định hơn
N_HIDDEN = 100          # Tăng lên 500 giúp "hồ chứa" ghi nhớ tốt hơn
LEARNING_RATE = 5e-2    # Giảm nu để tránh bão hòa trọng số
